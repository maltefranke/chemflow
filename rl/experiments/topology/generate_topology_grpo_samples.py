...
Run from the repository root:
    ...
    python -m rl.experiments.topology.generate_topology_grpo_samples

Writes ``topology_grpo_samples.pt`` under
``rl/experiments/topology/<rl_ckpt_stem>/`` by default. Trailing CLI args are
...
from rl.experiments.tanimoto.generate_tanimoto_grpo_samples import (
    _PROJECT_ROOT,
...
from rl.run_grpo import build_module_and_datamodule, compose_cfg
