...
uv run --active --env-file .env python -m rl.run_grpo \
    ...
    --n_updates 50 --num_steps 100 --a_sde 0 --lr 1e-4 \
    --max_grad_norm 1.0 \
    --reward n_atoms \
    --wandb --wandb_project chemflow-grpo --wandb_name phase2-natoms-seed0_alpha0 \
    --save .rl_ckpts/grpo_natoms_seed0_alpha0.pt \
