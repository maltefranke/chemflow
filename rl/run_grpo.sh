...
uv run --active --env-file .env python -m rl.run_grpo \
    ...
    --reward n_atoms \
    --wandb --wandb_project chemflow-grpo --wandb_name phase2-natoms-seed0_alpha0.05 \
    --save .rl_ckpts/grpo_natoms_seed0_alpha0.05.pt \
    --save_best .rl_ckpts/grpo_natoms_seed0_alpha0.05_best.pt \
